document.addEventListener('DOMContentLoaded', () => {
    ...
    const bios = {
        ...
        seetha: {
            name: "Dr. S. Seetha",
            role: "Trustee",
            text: `<p>Dr. S. Seetha is a distinguished space scientist who served the Indian Space Research Organisation (ISRO) for 39 years, contributing extensively to the development of space science and instrumentation in India. She served as Director of the Space Science Programme Office at ISRO Headquarters and was closely associated with several landmark missions, including AstroSat, Chandrayaan-2 and the Mars Orbiter Mission. She also played an important role in the approval of the Aditya-L1 and XPoSat missions.</p>
                   <p>With more than 100 research publications and experience guiding five Ph.D. students, Dr. Seetha has made significant contributions to scientific research and capacity building. She is currently an Honorary Member of the Raman Research Institute, Bengaluru.</p>
                   <p>Her contributions to science have been recognised through several prestigious awards, including the C.V. Raman Young Scientist Award in Physical Sciences from the Government of Karnataka, the Best Woman Scientist Award from the Astronautical Society of India, the ISRO Team Excellence Award for the AstroSat mission, the Distinguished Alumni Award from the Old Students Association of Hindu College, Delhi, and the ASI Zubin Kembhavi Award conferred on the AstroSat team.</p>
                   <p>Dr. Seetha holds a Ph.D. in Physics from the Indian Institute of Science, Bengaluru, an M.Sc. in Physics from IIT Madras, and a B.Sc. (Hons.) in Physics from Hindu College, University of Delhi.</p>`
        },
        jayashri: {
            name: "Jayashri Murali",
            role: "Advocate | Managing Partner, CMJ Law Offices",
            text: `<p>Jayashri Murali is a corporate lawyer with over 40 years of legal experience, specialising in corporate law, commercial transactions and regulatory compliance. She is a Law graduate having completed her Law degree from the University of Madras as a post graduation degree. Her under graduation is B.A. (Eng.Litt.) again from the University of Madras. She enrolled as a member of the Bar Association of Karnataka in Bangalore, India in the year 1984.</p>
                   <p>She began her legal career with Late N. Jayaraman, a pioneer in corporate and non-litigation practice in Bangalore, and was associated with him for over 15 years. She became a Partner at M/s. N. Jayaraman Advocates in 1995 and continued in that role until 2003. She subsequently spent two years with AZB &amp; Partners, Bangalore, before establishing her independent practice.</p>
                   <p><strong>Areas of Expertise</strong><br>Jayashri Murali’s practice encompasses corporate law and commercial transactions, including mergers and acquisitions, corporate restructuring, India-entry advisory and foreign investment, joint ventures, technical collaborations, business structuring, venture capital and financial entity structuring, incorporation and statutory compliances, transaction documentation, negotiations and execution, legal due diligence, and intellectual property rights including trademarks, copyrights and designs.</p>
                   <p><strong>CMJ Law Offices</strong><br>Jayashri Murali is the Managing Partner of CMJ Law Offices, a partnership firm established with two senior associates. The firm continues the practice established by her and provides legal advisory and transactional services across corporate law, commercial transactions and compliance.</p>
                   <p>Its practice includes corporate advisory, India-entry and incorporation services, statutory and secretarial compliance, employment and HR documentation, property transactions, joint ventures, technology transfer and collaboration agreements, share transactions, loan documentation, legal due diligence and intellectual property advisory. The firm works with clients throughout the transaction lifecycle, from negotiations and structuring through execution and post-transaction compliance.</p>
                   <p>The firm also has a dedicated litigation team handling matters before courts, tribunals and other forums across India, along with arbitration and mediation services.</p>`
        },
        kentaro: {
            name: "Kentaro Toyama",
